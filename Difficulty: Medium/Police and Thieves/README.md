<h2><a href="https://www.geeksforgeeks.org/problems/police-and-thieves--141631/1?_gl=1*splvd1*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjwsNnCBhDRARIsAEzia4C_wvhcGf1AKbuueQhl7M5lN1IB3hKaQh3OCJOk-9f4IoARhrWAb1MaAlwLEALw_wcB&gbraid=0AAAAAC9yBkDnGB5nPcYrCR9s9NXtNiMOj">Police and Thieves</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong>, where each element contains either a <strong>'P'</strong> for policeman or a <strong>'T'</strong> for thief. Find the <strong>maximum number of thieves </strong>that can be caught by the police.&nbsp;<br>Keep in mind the following conditions :</span></p>
<ol>
